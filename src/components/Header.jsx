...
const Header = () => {
  return (
    <header className="flex flex-row items-center bg-[#17181A] text-white p-3 rounded-lg lg:space-x-4 w-fit lg:ml-auto">
      {/* Network section with shadow and hover border */}
      <div
        className="flex items-center bg-[#1f262e] px-3 py-2 rounded-md lg:space-x-2 transition-all duration-300 text-xs sm:text-sm"
        style={{
      ...
      >
        ...
        <span className="flex lg:hidden items-center text-sm">
          BSC <IoMdArrowDropdown className="inline ml-1" />
        </span>
      </div>
